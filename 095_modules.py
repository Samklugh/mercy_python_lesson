...
# Modules are used to make our codes accessible to all folders in the same directory. To use a module, we need to import it. We can import a module using the import statement followed by the name of the module. For example, if we have a module named "math", we can import it as follows:

# importing from my system files:

# import z1

# we can use the formulars in the z1 module as follows:
# print(f"Area of the circle is: {z1.circle_area}")

# we can also import a variable in a module as used below
# samson=z1.radius**2
# print(samson)
...
# 
# that way, we can import only the variables or functions that we need from a module, which can help to reduce memory usage and improve performance.
