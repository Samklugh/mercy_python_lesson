...
cylinder_volume= 3.142 * radius**2 * height
prism_volume= rectangle_area * length
sphere_volume= (4/3) * 3.142 * radius**3
cylinder_volume= 3.142 * radius**2 * height
cone_volume= (1/3) * 3.142 * radius**2 * height
